...
function MailSender(){
  ...
  this.approveEvent = function(eventFinded){
    fs.readFile(process.env.PWD + '/views/email/approveEvent.html', {encoding: 'utf-8'}, function (err, html) {
      if (err) {
        throw err;
      }else{
        styliner.processHTML(html)
          .then(function(processedSource) {
            ...
            mailOptions.to = 'fmuner@britishschool.g12.br, bdiniz@britishschool.g12.br, adm_ict@britishschool.g12.br'
            mailOptions.subject = subjectConcat
            mailOptions.text = 'Approve Event'
            mailOptions.html = $('body').html()
